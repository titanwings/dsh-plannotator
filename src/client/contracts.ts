...
export interface QuestionWait {
  ...
  readonly payload: { readonly questions: readonly QuestionItem[] }
  respond(result: {
    readonly ok: true
    readonly value: { readonly sessionId: string; readonly answer: QuestionAnswer }
  } | {
    readonly ok: false
...
export interface ComposerChainProps {
  readonly interactions: readonly { readonly kind: string }[]
}
