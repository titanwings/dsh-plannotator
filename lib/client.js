...
function usePanelMode() {
  const [mode, setMode] = (0, import_react.useState)(readPanelMode);
...
function PlannotatorPanel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlannotatorReview, { matched, review, t }, `${matched.sessionId}:${matched.key}`);
}
function PlannotatorReview({
  ...
  const copy = copyOf(t);
  const revision = (0, import_react.useMemo)(() => planRevision(review.plan), [review.plan]);
  const storageKey = (0, import_react.useMemo)(() => draftKey(matched), [matched]);
  const restored = (0, import_react.useMemo)(() => parseStoredDraft(readDraft(storageKey), revision), [storageKey, revision]);
  const [annotations, setAnnotations] = (0, import_react.useState)(restored?.annotations ?? []);
  const [general, setGeneral] = (0, import_react.useState)(restored?.general ?? "");
  ...
  const [confirmApprove, setConfirmApprove] = (0, import_react.useState)(false);
  const mode = usePanelMode();
  const [openByMode, setOpenByMode] = (0, import_react.useState)({
    docked: true,
    drawer: false,
    sheet: false
  });
  const panelOpen = openByMode[mode];
  const panelId = `dsh-plannotator-panel-${(0, import_react.useId)().replaceAll(":", "")}`;
  const documentRef = (0, import_react.useRef)(null);
  const commentRef = (0, import_react.useRef)(null);
  const launcherRef = (0, import_react.useRef)(null);
  const panelTitleRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
  ...
  const captureSelection = (0, import_react.useCallback)(() => {
    const root = documentRef.current;
    if (root === null) return;
  ...
  const panel = panelOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "aside",
    {
      id: panelId,
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "dsh-plannotator-panel-header", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-panel-heading", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-plannotator-dot" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: `${panelId}-title`, ref: panelTitleRef, tabIndex: -1, children: copy.header }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: copy.annotation(annotations.length) })
            ] })
          ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-workspace", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              ref: documentRef,
              ...
              onKeyUp,
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.MarkdownText, { text: review.plan })
            }
          ),
          selection !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-plannotator-review", "aria-label": copy.annotation(annotations.length), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-review-title", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: copy.annotation(annotations.length) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: copy.shortcut })
            ] }),
            selection !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-plannotator-new", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-annotation-head", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: copy.newComment }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-quote", children: selection.quote }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "dsh-plannotator-visually-hidden", htmlFor: `${panelId}-comment`, children: copy.newComment }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "textarea",
                {
                  id: `${panelId}-comment`,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-mini-actions", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { size: "sm", variant: "ghost", onClick: () => {
                  setSelection(null);
                  setComment("");
                }, children: copy.cancel }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { size: "sm", className: "dsh-plannotator-blue-button", disabled: comment.trim() === "", onClick: addComment, children: copy.add })
              ] })
            ] }),
            annotations.map((annotation, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-plannotator-annotation", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-annotation-head", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "dsh-plannotator-icon-button", onClick: () => {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "dsh-plannotator-icon-button dsh-plannotator-quote", onClick: () => {
                focusAnnotation(annotation);
              }, children: annotation.quote }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-comment", children: annotation.comment })
            ] }, annotation.id)),
            selection === null && annotations.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-empty", children: copy.selectHint }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-plannotator-general", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "dsh-plannotator-annotation-head", htmlFor: `${panelId}-overall`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: copy.overall }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "textarea",
                {
                  id: `${panelId}-overall`,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", { className: "dsh-plannotator-footer", children: [
          error !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-status", role: "alert", children: error }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-plannotator-status", role: "status", "aria-live": "polite", children: confirmApprove ? copy.discardConfirm : "" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_dsh_client_ui_primitives.Button,
              {
                size: "sm",
                variant: "ghost",
                icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconEditOutline16, { size: 14 }),
                disabled: busy !== null,
                onClick: () => {
  ...
  ) : mode === "docked" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "button",
    {
      type: "button",
      ...
      onClick: openPanel,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconChevronLeftOutline14, {}),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: copy.reopen }),
        annotations.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: annotations.length })
      ]
    }
  ) : null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-launcher", "data-plan-review-key": matched.key, "data-dsh-plannotator-launcher": "", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-plannotator-dot" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-plannotator-launcher-copy", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: copy.ready }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: copy.readyHint })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
